...
<body style="background: rgb(255,255,255);color: rgb(0,0,0);">
            ...
            <table class="table table-hover table-bordered">
                <thead class="bill-header cs">
                    <tr>
                        ...
                        <th id="trs-hd-2" class="col-lg-2">titulo</th>
                        <th id="trs-hd-3" class="col-lg-3">precio</th>
                        <th id="trs-hd-4" class="col-lg-2">descripcion</th>
                        <th id="trs-hd-5" class="col-lg-2">imagen</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>kjhewh</td>
                        <td><a class="btn btn-success" role="button" data-bss-hover-animate="pulse" style="margin-left: 5px;" href="ActualizarHabitacióndoble.php"><i class="fa fa-check" style="font-size: 15px;"></i></a><button class="btn btn-danger" data-bss-hover-animate="pulse" style="margin-left: 5px;" type="submit"><i class="fa fa-trash" style="font-size: 15px;"></i></button></td>
                    </tr>
                </tbody>
            </table>
        </div>
