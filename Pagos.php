...
<body style="background: var(--bs-body-bg);color: var(--bs-emphasis-color);">
    <div class="col"><a class="btn btn-primary" role="button" href="PAGINAADMI.php">Categorías</a></div>
            ...
            <table class="table table-hover table-bordered">
                <thead class="bill-header cs">
                    <tr>
                        ...
                        <th id="trs-hd-2" class="col-lg-2">Área</th>
                        <th id="trs-hd-3" class="col-lg-3">Trabajo</th>
                        <th id="trs-hd-4" class="col-lg-2">Días</th>
                        <th id="trs-hd-5" class="col-lg-2">Cantidad&nbsp;</th>
                        <th id="trs-hd-7" class="col-lg-2">Total</th>
                        <th id="trs-hd-6" class="col-lg-2">Actividad</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>$200</td>
                        <td>$400</td>
                        <td><a class="btn btn-success" role="button" style="margin-left: 5px;" href="formularioActualizarpago.php"><i class="fa fa-check" style="font-size: 15px;"></i></a><button class="btn btn-danger" style="margin-left: 5px;" type="submit"><i class="fa fa-trash" style="font-size: 15px;"></i></button></td>
                    </tr>
                </tbody>
            </table>
        </div>
