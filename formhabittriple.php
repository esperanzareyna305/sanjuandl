                ...
                <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                    <div class="card mb-5">
                        <div class="card-body p-sm-5">
                            <h2 class="text-center mb-4">crear habitación triple</h2>
                            <form method="post">
                                <div class="mb-3"><input class="form-control" type="text" id="name-2" name="name" placeholder="Nombre"></div>
                                <div class="mb-3"><input class="form-control" type="email" id="email-2" name="email" placeholder="Precio"></div>
                                <div class="mb-3"><textarea class="form-control" id="message-2" name="message" rows="6" placeholder="Descripción"></textarea></div><input class="form-control" type="file">
                                <div><a class="btn btn-primary d-block w-100" role="button" href="categoríascrear.php" style="margin-top: 13px;">GUARDAR</a></div>
                            </form><a href="listabungalows.php">ver mas</a>
                        </div>
                    </div>
                </div>
            </div>
