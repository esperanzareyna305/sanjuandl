                ...
                <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                    <div class="card mb-5">
                        <div class="card-body p-sm-5">
                            <h2 class="text-center mb-4">Actualizar Habitación triple</h2>
                            <form method="post">
                                ...
                                <div><a class="btn btn-primary d-block w-100" role="button" href="#">Guardar</a></div>
                            </form><a href="#">ver mas</a>
                        </div>
                    </div>
                </div>
            </div>
